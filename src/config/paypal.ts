...
export const PRODUCTS = {
  PREMIUM_MONTHLY: {
    ...
    directPaymentUrl: 'https://www.paypal.com/paypalme/chatbloom@mail.com/2.99'
  },
  PREMIUM_YEARLY: {
    ...
    id: 'premium-yearly',
    hostedButtonId: '',
    directPaymentUrl: 'https://www.paypal.com/paypalme/chatbloom@mail.com/29.99'
  },
  ONE_TIME_FEATURES: {
    ...
    directPaymentUrl: 'https://www.paypal.com/paypalme/chatbloom@mail.com/4.99'
  },
  ALL_INCLUSIVE: {
    ...
    directPaymentUrl: 'https://www.paypal.com/paypalme/chatbloom@mail.com/9.99'
  }
};

// Notes on PayPal integration:
// 1. Currently using sandbox mode for testing - switch to 'production' when ready
// 2. PayPal.me username is set to "chatbloom@mail.com"
